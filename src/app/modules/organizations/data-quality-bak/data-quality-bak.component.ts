...
@Component({
  selector: 'seed-organizations-data-quality-bak',
  templateUrl: './data-quality-bak.component.html',
...
export class DataQualityBakComponent implements OnDestroy, OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getOrg()
    this.getColumns()
    this._dataQualityService.rules$.pipe(
