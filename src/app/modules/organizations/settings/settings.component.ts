...
export class SettingsComponent {
  settingsNavigationMenu: NavigationItem[] = [
    ...
    {
      id: 'organizations/settings/api_key',
      link: '/organizations/settings/api_key',
      title: 'API Key',
      type: 'basic',
    },
    {
      id: 'organizations/settings/audit_template',
      link: '/organizations/settings/audit_template',
      title: 'Audit Template',
      type: 'basic',
    },
    {
      id: 'organizations/settings/default_display_fields',
      link: '/organizations/settings/default_display_fields',
    ...
    {
      id: 'organizations/settings/two_factor',
      link: '/organizations/settings/two_factor',
